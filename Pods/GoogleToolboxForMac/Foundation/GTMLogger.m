...
+ (id)standardLogger {
  ...
  @catch (id e) {
      NSLog(@"standardLogger error"); // Ignored
  }
  return nil;
}
...
+ (id)standardLoggerWithStderr {
  ...
  @catch (id e) {
    NSLog(@"standardLoggerWithStderr error"); // Ignored
  }
  return nil;
}
...
+ (id)standardLoggerWithStdoutAndStderr {
  ...
  @catch (id e) {
      NSLog(@"standardLoggerWithStdoutAndStderr error"); // Ignored
  }
  return nil;
}
...
+ (id)standardLoggerWithPath:(NSString *)path {
  ...
  @catch (id e) {
    NSLog(@"standardLoggerWithPath error"); // Ignored
  }
  return nil;
}
...
- (void)setWriter:(id<GTMLogWriter>)writer {
  @synchronized(self) {
    ...
    if (writer == nil) {
      ...
      @catch (id e) {
        NSLog(@"writer_ error"); // Leave |writer_| nil
      }
    } else {
...
- (void)setFormatter:(id<GTMLogFormatter>)formatter {
  @synchronized(self) {
    ...
    if (formatter == nil) {
      ...
      @catch (id e) {
        NSLog(@"formatter_ error"); // Leave |formatter_| nil
      }
    } else {
...
- (void)setFilter:(id<GTMLogFilter>)filter {
  @synchronized(self) {
    ...
    if (filter == nil) {
      ...
      @catch (id e) {
        NSLog(@"filter_ error"); // Leave |filter_| nil
      }
    } else {
...
- (void)logInternalFunc:(const char *)func
  ...
  @catch (id e) {
    NSLog(@"logInternalFunc error"); // Ignored
  }
}
...
- (void)logMessage:(NSString *)msg level:(GTMLoggerLevel)level {
  @synchronized(self) {
    ...
    @catch (id e) {
      NSLog(@"logMessage error"); // Ignored
    }
  }
}
